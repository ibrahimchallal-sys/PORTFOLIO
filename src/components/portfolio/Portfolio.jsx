...
const projectData = [
  {
    id: 1,
    image: card1,
    category: "Web site for freelancers and digital sellers",
    title: "TOGETHER !",
    description:
      "A web site where the digital sellers can show there skills and sell there digital products and servises",
    link: "#!",
  },
  {
    id: 2,
